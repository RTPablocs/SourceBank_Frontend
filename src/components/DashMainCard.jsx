export default function DashMainCard({balance, title, icon, }) {
    return (
        <div className="shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-800">
            <div className="flex items-center">
        <span className="rounded-xl relative p-4 bg-blue-200">
            <svg width="40" fill="currentColor" height="40"
                 className="text-blue-500 h-4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
